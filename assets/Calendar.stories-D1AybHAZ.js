import{j as e,r as T}from"./iframe-Btc7p_dI.js";import{C as D,a as j,b as S,f as s,D as o}from"./CalendarWeekDayNames-Cvwk6POE.js";import{I as A}from"./InputError-DveFmxaA.js";import"./classnames-helper-C6tUBjOJ.js";import"./validation-helper-Bjp8riig.js";import"./Icon-BYjfzI_Q.js";import"./Flex-BpYkVn-f.js";const d=({fullWidthHeigh:a=!1,disabled:r=!1,markedDays:u=[],field:n,onChange:x})=>{const F=a?{height:"100%",width:"100%"}:{},y=r?()=>{}:x;return e.jsxs("div",{className:"calendar",style:F,children:[e.jsx(D,{disabled:r,field:n,onChange:y}),e.jsx(j,{}),e.jsx(S,{markedDays:u,field:n,onChange:y,disabled:r}),n.error&&e.jsx(A,{error:n.error})]})};d.__docgenInfo={description:"",methods:[],displayName:"Calendar",props:{defaultDate:{required:!1,tsType:{name:"string"},description:""},markedDays:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
...
| Array<string>`,elements:[{name:"string"},{name:"number"},{name:"boolean"},{name:"File"},{name:"Array",elements:[{name:"File"}],raw:"File[]"},{name:"null"},{name:"Array",elements:[{name:"string"}],raw:"Array<string>"}],required:!0}},{key:"name",value:{name:"string",required:!0}},{key:"formName",value:{name:"string",required:!0}},{key:"error",value:{name:"string",required:!0}},{key:"section",value:{name:"number",required:!0}},{key:"validate",value:{name:"signature",type:"object",raw:`{
  ...
  render: args => <Wrapper {...args} />
}`,...(h=(w=i.parameters)==null?void 0:w.docs)==null?void 0:h.source}}};const W=["Default","WithError","Disabled"];export{t as Default,i as Disabled,l as WithError,W as __namedExportsOrder,U as default};
