import{j as e}from"./iframe-cc5ZmNpn.js";import{g as b}from"./classnames-helper-C6tUBjOJ.js";import{v as p}from"./validation-helper-Bjp8riig.js";import{I as v}from"./InputError-EatG13S7.js";const g=({label:i,className:s,title:u,field:a,disabled:n=!1,size:t="md",color:m,isSwitch:r=!1,onChange:o})=>{const l=!!a.value,d=b({"custom-checkbox":!r,"custom-switch":r,[`checkbox-${m}`]:m!==void 0,[`checkbox-${t}`]:t!=="md",checked:l,disabled:n,[`${s}`]:s!==void 0}),c=()=>{n||p({...a,value:!l},o)};return e.jsxs(e.Fragment,{children:[e.jsxs("label",{className:d,title:u,children:[e.jsx("input",{type:"checkbox",name:a.name,checked:l,onChange:c,disabled:n,className:"checkbox-input"}),e.jsx("div",{className:r?"switch-button":"checkbox-button"}),i&&e.jsx("span",{className:"checkbox-label",children:i})]}),a.error&&e.jsx(v,{error:a.error})]})};g.__docgenInfo={description:"",methods:[],displayName:"CheckBox",props:{label:{required:!1,tsType:{name:"union",raw:"string | React.ReactNode",elements:[{name:"string"},{name:"ReactReactNode",raw:"React.ReactNode"}]},description:""},title:{required:!1,tsType:{name:"string"},description:""},className:{required:!1,tsType:{name:"string"},description:""},field:{required:!0,tsType:{name:"signature",type:"object",raw:`{
