...
| Array<string>`,elements:[{name:"string"},{name:"number"},{name:"boolean"},{name:"File"},{name:"Array",elements:[{name:"File"}],raw:"File[]"},{name:"null"},{name:"Array",elements:[{name:"string"}],raw:"Array<string>"}],required:!0}},{key:"name",value:{name:"string",required:!0}},{key:"formName",value:{name:"string",required:!0}},{key:"error",value:{name:"string",required:!0}},{key:"section",value:{name:"number",required:!0}},{key:"validate",value:{name:"signature",type:"object",raw:`{
  ...
  render: () => {
    ...
    return <Form>\r
        <Input label={<>Username 👱</>} field={usernameField} onChange={setUsernameField} />\r
\r
...
\r
        <Autoselect className="mt-4" label="City 🌆" placeholder="Start typing a city..." field={cityField} options={cityOptions} onChange={setCityField} />\r
\r
        <InputNumber className="mt-4" label="Quantity" min={1} max={10} field={quantityField} onChange={setQuantityField} />\r
\r
        <ImageDropZone className="mt-4" field={imagesField} onChange={setImagesField} maxImages={5} />\r
\r
        <div className="mt-4">\r
          <h6>Select Gender</h6>\r
          <div className="d-flex gap-2">\r
            ...
            <Radio field={genderField} checkedValue="female" label="Female" variant={false} btnSize="sm" onChange={setGenderField} />\r
            <Radio field={genderField} checkedValue="other" label="Other" variant={false} btnSize="sm" onChange={setGenderField} />\r
          </div>\r
        </div>\r
\r
        <TextArea className="mt-4" label="Bio" field={bioField} onChange={setBioField} rows={4} cols={40} />\r
\r
        <CheckBox className="mt-4" label={<>\r
              I accept the{" "}\r
              <Link to="https://example.com/terms" variant="info" blank>\r
                terms and conditions\r
              </Link>\r
            </>} field={termsField} onChange={setTermsField} />\r
\r
        <div className="mt-3">\r
          <CheckBoxIcon field={termsField} onChange={setTermsField} title="Agree to terms">\r
            <span style={{
            padding: "0.5rem 1rem",
            ...
            cursor: "pointer"
              ...
              ✅ Custom Toggle Consent\r
            </span>\r
          </CheckBoxIcon>\r
        </div>\r
\r
        <Button variant="primary" className="mt-4" isLoading={false}>\r
          Submit Form\r
        </Button>\r
      </Form>;
  }
