import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{L as n}from"./Link-DZTEqmlO.js";import"./classnames-helper-C6tUBjOJ.js";const u=["primary","secondary","success","danger","warning","info","light","dark"],_={title:"Navigation/Link",component:n,tags:["autodocs"],args:{to:"#",children:"Link Text",variant:"primary",underlined:!1,disabled:!1,blank:!1,asButton:!1},argTypes:{variant:{control:"radio",options:u},underlined:{control:"boolean"},disabled:{control:"boolean"},blank:{control:"boolean"},asButton:{control:"boolean"},to:{control:"text"}}},s={render:a=>e.jsx(n,{...a})},t={render:a=>e.jsx("div",{style:{display:"flex",gap:"1rem",flexWrap:"wrap"},children:u.map(r=>e.jsxs(n,{...a,variant:r,to:"#",children:[r.charAt(0).toUpperCase()+r.slice(1)," Link"]},r))})},o={args:{underlined:!0,children:"Underlined Link"},render:a=>e.jsx("div",{style:{display:"flex",gap:"1rem",flexWrap:"wrap"},children:u.map(r=>e.jsxs(n,{...a,variant:r,to:"#",children:[r.charAt(0).toUpperCase()+r.slice(1)," Underlined"]},r))})},i={args:{disabled:!0,variant:"danger",children:"Disabled Link"}},l={args:{to:"https://example.com",variant:"info",blank:!0,children:"Open in new tab"}},c={render:()=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"1rem"},children:[e.jsx(n,{variant:"primary",to:"#",className:"hover-example",children:"Hover Me (use your mouse)"}),e.jsx(n,{variant:"success",to:"#",className:"focus-example focus-outline",children:"Focus Me (tab key)"})]})},d={args:{asButton:!0,children:"Button Style Link"},render:a=>e.jsx("div",{style:{display:"flex",gap:"1rem",flexWrap:"wrap"},children:u.map(r=>e.jsx(n,{...a,variant:r,to:"#",children:r.charAt(0).toUpperCase()+r.slice(1)},r))})},p={args:{to:"#",asButton:!0,block:!0,variant:"primary",children:"Full Width Button"},render:a=>e.jsx("div",{style:{width:"100%",maxWidth:"300px"},children:e.jsx(n,{...a})})};var m,v,x;s.parameters={...s.parameters,docs:{...(m=s.parameters)==null?void 0:m.docs,source:{originalSource:`{
  ...
  render: args => <div style={{
    ...
    flexWrap: "wrap"
      ...
      {variants.map(variant => <Link key={variant} {...args} variant={variant} to="#">\r
          {variant.charAt(0).toUpperCase() + variant.slice(1)} Link\r
        </Link>)}\r
    </div>
  ...
  render: args => <div style={{
    ...
    flexWrap: "wrap"
      ...
      {variants.map(variant => <Link key={variant} {...args} variant={variant} to="#">\r
          {variant.charAt(0).toUpperCase() + variant.slice(1)} Underlined\r
        </Link>)}\r
    </div>
  ...
  render: () => <div style={{
    ...
    gap: "1rem"
      ...
      <Link variant="primary" to="#" className="hover-example">\r
        Hover Me (use your mouse)\r
      </Link>\r
      <Link variant="success" to="#" className="focus-example focus-outline">\r
        Focus Me (tab key)\r
      </Link>\r
    </div>
