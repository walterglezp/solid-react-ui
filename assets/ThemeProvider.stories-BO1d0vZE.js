  ...
  render: args => {
    ...
    return <div style={{
      padding: "2rem"
        ...
        <label className="form-label mb-2">Border Radius</label>\r
        <select className="form-select mb-3 w-auto" value={radius} onChange={e => setRadius(e.target.value)}>\r
          <option value="0rem">None</option>\r
          <option value="0.25rem">Small (4px)</option>\r
          <option value="0.375rem">Medium (6px)</option>\r
          <option value="0.5rem">Large (8px)</option>\r
          <option value="1rem">Extra Large (16px)</option>\r
        </select>\r
\r
        <ThemeProvider value={{
        ...
        borderRadius: radius
          ...
          <Button variant="success">Success Button</Button>\r
        </ThemeProvider>\r
      </div>;
  }
