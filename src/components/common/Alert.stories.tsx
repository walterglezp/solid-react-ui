...
export const WithLongTitle: Story = {
  args: {
    ...
    children:
      "Your account shows unusual activity. We recommend changing your password immediately to keep your account secure.",
  },
};
...
export const Dismissible: Story = {
  args: {
    ...
    children:
      "Check out our latest feature that will help improve your workflow.",
  },
};
...
export const CustomIconComplex: Story = {
  args: {
    variant: "info",
    icon: (
      <svg
...
export const DifferentLayouts: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Different layout combinations showing the flexibility of the Alert component.",
      },
    },
  },
};
...
export const VeryLongTitle: Story = {
  args: {
    variant: "warning",
    title:
      "This is an extremely long title that might wrap to multiple lines depending on the available space and screen size",
